...
trait ThreadTraits{
    ...
    public function return_no_tongren_thread_fields($query){
        ...
        'users.name', 'labels.labelname', 'channels.channelname', 'posts.trim_body as last_post_body', 'threads.top', 'threads.recommended','threads.jinghua');
        return $query;
    }

...
trait ThreadTraits{
    ...
    public function return_thread_fields($query){
        ...
        'users.name', 'labels.labelname', 'channels.channelname', 'posts.trim_body as last_post_body', 'threads.top',
    ...
    public function return_no_book_thread_fields($query){
        $query->select('threads.id', 'threads.id  as thread_id' ,'threads.user_id','threads.book_id', 'threads.title', 'threads.brief', 'threads.locked', 'threads.public', 'threads.bianyuan', 'threads.anonymous', 'threads.majia', 'threads.noreply', 'threads.viewed', 'threads.responded', 'threads.lastresponded_at',  'threads.channel_id', 'threads.label_id', 'threads.deleted_at', 'threads.created_at',  'threads.edited_at', 'threads.homework_id', 'threads.post_id', 'threads.last_post_id', 'threads.show_homework_profile', 'threads.downloaded', 'threads.top', 'users.name', 'labels.labelname', 'channels.channelname', 'posts.trim_body as last_post_body');
        return $query;
    }

    public function return_no_tongren_thread_fields($query){
        $query->select('books.thread_id','books.book_status', 'books.book_length', 'books.lastaddedchapter_at', 'books.total_char', 'books.last_chapter_id', 'books.sexual_orientation',
        'threads.id','threads.user_id','threads.book_id', 'threads.title', 'threads.brief', 'threads.locked', 'threads.public', 'threads.bianyuan', 'threads.anonymous', 'threads.majia', 'threads.noreply', 'threads.viewed', 'threads.responded', 'threads.lastresponded_at', 'threads.channel_id', 'threads.label_id', 'threads.deleted_at', 'threads.created_at', 'threads.edited_at', 'threads.homework_id', 'threads.post_id', 'threads.last_post_id', 'threads.show_homework_profile', 'threads.downloaded', 'threads.top', 

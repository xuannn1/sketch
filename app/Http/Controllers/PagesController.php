...
class PagesController extends Controller
{
    ...
    public function findrecommendedbooks_short($take, $past)//寻找合适的推荐，非长评:需要valid，新的（非past）$take-3个，past 3个.如果$past为1，都找往期
    {
    ...
    public function findrecommendedbooks_long($take, $past)//寻找合适的长评推荐，如果$past为1，都找往期
    {
        return DB::table('recommend_books')

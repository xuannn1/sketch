...
class DownloadsController extends Controller
{
    ...
    */
    ...
    //         $txt .= "回复".StringProcess::trimtext($post->reply_to_post->title . $post->reply_to_post->body, 20)."\n";
    //     }elseif(($post->chapter_id!=0)&&(!$post->maintext)&&($post->chapter->mainpost->id>0)){
    //         $txt .= "评论".StringProcess::trimtext( $post->chapter->title . $post->chapter->mainpost->title . $post->chapter->mainpost->body , 20)."\n";
    //     }
    //     return $txt;
    // }
    ...
    //     }else{
    //         $string = StringProcess::wrapParagraphs($string);
    //     }
    //     if($indentation)
    //     {

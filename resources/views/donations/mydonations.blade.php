    ...
    <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
        <div class="panel panel-default">
            <div class="panel-body text-center">
                ...
                <h5><a href="https://www.patreon.com/sosadfun">赞助废文网（sosad.fun）项目</a></h5>
            </div>
        </div>
        <div class="panel panel-default">
        ...
        <div class="panel panel-default">
            <div class="panel-body font-5">
                <h4>我的福利现状</h4>
                <div>
                    我的赞助等级：{{ array_key_exists($info->patreon_level, config('donation'))? config('donation')[$info->patreon_level]['title']:'暂无'}}
                </div>
                <div class="">
                    免广告：{{$user->no_ads?'是':'否'}}
                </div>
                <div class="">
                    免广告福利码余额：{{$info->no_ads_reward_limit}}<br>
                    @if($info->patreon_level>=4&&$info->no_ads_reward_limit>0)
                    <a href="#" class="btn btn-md btn-primary sosad-button">消耗额度创建免广告福利码</a>
                    @endif
                </div>
                <div class="">
                    补签福利码余额：{{$info->qiandao_reward_limit}}<br>
                    @if($info->patreon_level>=4&&$info->qiandao_reward_limit>0)
                    <a href="#" class="btn btn-md btn-primary sosad-button">消耗额度创建补签福利码</a>
                    @endif

        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                ...
                <div class="panel-body">
                    ...
                    <div class="row h5">
                        <div class="{{ $invitation_token->invite_until<Carbon\Carbon::now()||$invitation_token->invitation_times<=0 ?'grayout':''}}">
                            ...
                            <span>
                                创建时间：{{ Carbon\Carbon::parse($invitation_token->created_at)->setTimezone('Asia/Shanghai') }}
                            </span>
                            <span>
                                失效时间：{{ Carbon\Carbon::parse($invitation_token->invite_until)->setTimezone('Asia/Shanghai') }}
                            </span>
                            <span>
                                每日更新：{{ $invitation_token->refresh_times }}
                            </span>
                        </div>
                    </div>
                    <hr>

        ...
        <span class="button-group">
            ...
            <ul class="dropdown-menu">
                @foreach($selector['withType'] as $withType => $explanation)
                    <li><a class="" href="{{ route('thread.show', array_merge(['thread'=>$thread->id, 'withType' => $withType], request()->only('withComponent','withFolded', 'userOnly', 'withReplyTo', 'inComponent', 'ordered'))) }}">{{$explanation}}</a></li>
                @endforeach
        ...
        <span class="button-group">
            ...
            <ul class="dropdown-menu">
                @foreach($selector['withComponent'] as $withComponent => $explanation)
                    <li><a class="" href="{{ route('thread.show', array_merge(['thread'=>$thread->id, 'withComponent' => $withComponent], request()->only('withType', 'withFolded', 'userOnly', 'withReplyTo', 'inComponent', 'ordered'))) }}">{{$explanation}}</a></li>
                @endforeach
            </ul>
        </span>
        <span class="button-group">
            ...
            <ul class="dropdown-menu">
                @foreach($selector['withFolded'] as $withFolded => $explanation)
                    <li><a class="" href="{{ route('thread.show', array_merge(['thread'=>$thread->id, 'withFolded' => $withFolded], request()->only('withType', 'withComponent', 'userOnly', 'withReplyTo', 'inComponent', 'ordered'))) }}">{{$explanation}}</a></li>
                @endforeach
        ...
        <span class="button-group">
            ...
            <ul class="dropdown-menu">
                @foreach($selector['ordered'] as $ordered => $explanation)
                    <li><a class="" href="{{ route('thread.show', array_merge(['thread'=>$thread->id, 'ordered' => $ordered], request()->only('withType', 'withComponent','withFolded', 'userOnly', 'withReplyTo', 'inComponent'))) }}">{{$explanation}}</a></li>
                @endforeach
            </ul>
        </span>
    </div>

...
<form method="POST" action="{{ route('messages.store', $user->id) }}">
    ...
    <div class="form-group">
        ...
        <button type="button" onclick="retrievecache('messagetouser')" class="sosad-button-ghost grayout">恢复数据</button>
    </div>
    <button type="submit" class="sosad-button-auth">发布</button>
</form>

                        ...
                        <div class="help-navigation h5">
                            <ol>
                                ...
                                <ul>
                                    ...
                                    <li><a href="#help-3-2">文章控制操作</a></li>
                                </ul>
                                ...
                                <ul>
                                    ...
                                    <li><a href="#help-4-8">更多问题？戳我看FAQ/提问！</a></li>
                                </ul>
                            ...
                            <div id="help-1">
                                <h2>1 网站界面</h4>
                                    <div id="help-1-1">
                                        ...
                                        <ul>
                                            ...
                                            <li>登陆：论坛可以使用用户名或邮箱进行登陆</li>
                                            <li>激活：注册后需通过邮件激活账户才可使用，从“编辑资料-激活邮箱”页面进入</li>
                                            <li>忘记密码： 在登陆页面点选“忘记密码/重新激活”，输入自己的邮箱，即可接收重置密码邮件，点开其中的链接重置密码。</li>
                                            <li>重置邮件也不管用：请选择用户名+密码形式登陆，登陆后从“编辑资料-修改邮箱”处查看邮箱是否正确，用以更换合适的邮箱。</li>
                                            <li>安全考虑，目前不开放手工修改邮箱，请根据用户名或邮箱之一自行登陆，自主修改。</li>
                                            <li>关于邮箱激活的一切问题，看这里<a href="route('thread.show', 14361)">《万能的邮箱激活验证/修改/使用指南》</a></li>
                                        </ul>
                                    </div>
                                    <br>
                                    <div id="help-1-2">
                                        ...
                                        <div class="main-text indentation">
                                            <p>以上是本站特色的虚拟积分系统。发文、发帖、回帖、点评、签到、参加活动……都能增加这些积分。积分影响等级，等级影响到网站一小部分的功能使用，比如发送私信等。咸鱼和剩饭能够对作者进行奖励。丧点可以用于参加站内作业活动。本站大部分功能对全部用户开放，不需要也不建议对虚拟分值过于纠结。</p>
                                    ...
                                    <div id="help-1-3">
                                        ...
                                        <ul>
                                            <li>签到按钮（登陆可见）：在导航栏最顶，有一个红色的<code>“我要签到”</code>按键。为了避免用户熬夜签到，签到按钮设置在<u>北京时间早上8点</u>开始出现，出现后只要用户不签到就会一直存在（因此不需要卡在这个时候上线！不需要！不需要！咸鱼随缘就可以了！）直到用户完成签到后再次消失等待下一天。找不到签到按钮说明今天的签到已经完成了，不是bug不是bug不是bug。只有48小时不签到才会断签。签到有签到奖励，签到可以让用户升级（具体升级需求请看<em><a href="#help-5-2">帮助5.2</a></em> ），连续签到达到一定日期之后，奖励也会增加。</li>
                                            <li>动态：用户动态及用户列表。</li>
                                    ...
                                    <div id="help-1-5">
                                        ...
                                        <ul>
                                            ...
                                            <li>关于页面：本站概况和相关原则（版规）。<code>站内注册用户默认遵守这些规则，请务必仔细查看。</code></li>
                                            <li>Github：本站源代码。</li>
                                ...
                                <div id="help-2">
                                    ...
                                    <div id="help-2-1">
                                        ...
                                        <ul>
                                            <li><code>a. 单项淘文：</code>在文库区，点击任何关于“书籍进度（连载/完结/暂停）”，“书籍篇幅（短篇中篇长篇）”，“书籍原创性（原创/同人）”，“书籍性向（BL/GL/BG/GB/无CP/混合性向/其他性向）”，“书籍类型（科幻/奇幻/现代/古代...）”，“书籍标签（美强/强强/正剧/小甜饼/暗黑/HE...）”以上任何超链接，点击之后，都可以跳转进入筛选页面。浏览器收藏该页面，下次就可以直接淘这类文章。请注意等级较低时一部分标签是不可见的，请耐心升级。</li>
                                            <li><code>b. 复合淘文（积极排除不想看的类型）：</code>点击导航栏“文库”按钮即可进入文库淘文。就在导航栏之下，有筛选功能。这里提供复合筛选，并且一键进入该筛选特定的网页。读者可以收藏筛选结果所在的网页，日后直接一键进入淘文。</li>
                                            <li>关于文库排序：目前文库按照最后更新章节时间倒序排列（此章节必须达到一定字数要求，数据见本页最下的“实时数据”展示）。在论坛和文库，一共有以下四种<code>排序</code>方式：按最新回复排序/按最新章节排序/按总积分排序/按均字数积分排序。其中，积分是书籍回帖、点击等情况的数值综合，较体现文章的热度。</li>
                                        </ul>
                                    </div>
                                    <br>
                                    <div id="help-2-2">
                                    ...
                                    <div id="help-2-4">
                                        ...
                                        <ul>
                                            ...
                                            <li>点评：留下一句简短的评价，跟随在帖子底部。</li>
                                            <li>赞赏：在单独章节下点击向上的小手，太太能够收到闪烁的黄色提醒</li>
                                            <li>收藏：将本文加入收藏夹，获得更新提醒，收藏数字是文章质量的一大标志。（收藏数字是实时的、真实的，会掉收藏）</li>
                                        </ul>
                                    </div>
                                </div>
                                <br>
                                <div id="help-3">
                                    ...
                                    <div id="help-3-1">
                                        <h4>3.1 发文入口</h4>
                                        <ul>
                                            <li>发文入口只能发布“原创小说”和“同人小说”！不能发布其他内容的讨论帖，如举报、随笔、读书记录、日志……主题贴的发布，从首页各个版面进入，进入对应版面后拖到最下，即可找到发帖按钮。请注意，等级过低的用户无法发布主题贴。</li>
                                            <li>所有用户发文/发帖前，需先阅读 <em><a href="{{ route('thread.show', 136) }}">版规</a></em>。</li>
                                    ...
                                    <div id="help-3-2">
                                        <h4>3.2 作者能做的操作</h4>
                                        <h6>以下操作都从文章首页的<code>“修改文案”</code>进入，方法为拖拽到底部将对应项打勾/取消勾选</h6>
                                        <ul>
                                            <li>是否公开书籍：如果不勾选，则书籍不对外开放，只能从个人主页进入，可以作为<code>私下存文</code>的渠道。管理员发现帖子标题等处不规范，也会将该项取消勾选（也就是隐藏处理），作者修改好后可以自行公开，恢复帖子的阅读。请注意，24h无正文的，系统会自动隐藏。标题侧边显示<span class="glyphicon glyphicon-eye-close"></span>，表示文章处于隐藏状态，作者可自己选择公开。</li>
                                            <li>是否允许跟帖：如果不勾选，其他读者只能看文不能评论。如果遇到文下争议，来不及等待管理员处理，此操作可以应急。（之后可以悠哉悠哉地去管理版面登记，举报不友好评论，惩罚ky分子）。标题侧边显示<span class="glyphicon glyphicon-warning-sign"></span>表示文章处于禁止跟帖状态，楼主可以自己选择取消禁止跟帖状态。</li>
                                            <li>是否允许讨论帖格式下载：勾选后，其他读者能够以支付作者咸鱼和剩饭为代价，实时下载包含书评在内、按时间顺序排列的全文txt文件作为存档。本选项默认不勾选。</li>
                                            <li>是否允许书籍格式下载：勾选后，高等级读者能够以支付作者<em>更多</em>咸鱼和剩饭为代价，实时下载不包含书评在内，只含章节正文的纯净书籍txt文件。本选项默认不勾选。</li>
                                        </ul>
                                    </div>
                                </div>
                                <br>
                                <div id="help-4">
                                    ...
                                    <div id="help-4-4">
                                        ...
                                        <div class="indentation main-text">
                                            <p>用户登录后，所有大文本框下均有<code>”恢复数据“</code>按键，是随时向服务器提交您之前输入的数据的，点选它即可恢复上次输入的文本文件。【多次】点击“恢复数据”可以从多个恢复数据档案中切换<code>如果不小心误按，再点一次即可撤销回到之前状态。</code></p>
                                        </div>
                                    </div>
                                    <br>
                                    <div id="help-4-5">
                                    ...
                                    <div id="help-4-8">
                                        <h4>4.8 更多问题？戳我</h4>
                                        <div class="indentation main-text">
                                            <li><a href="https://sosad.fun/threads/9756">《网站使用FAQ汇总楼》</a>把更多常见基本问题写成<code>问题-回答</code>的形式，分楼汇总，方便查看。</li>
                                            <li><a href="https://sosad.fun/threads/49">《网站使用答疑楼》</a>若还有不明白的，可以前往答疑楼实时提问。</li>
                                        </div>
                                    </div>
                                </div>
                                <br>
                                    ...
                                    <ul>
                                        ...
                                        <div id="help-5-3">
                                            ...
                                            <div class="main-text indentation">
                                                ...
                                                <p>普通互动，比如回帖、点评、签到、投掷咸鱼剩饭、赞赏，都能增加积分、盐度（也就是经验）。签到送数值不等的咸鱼、剩饭、盐度、积分，连续签到次数越多，每次签到奖励的页越多，有时会出现额外奖励（些许剩饭咸鱼，额度很低，不要纠结）。更新书籍章节、发表长评、回帖获得高赞，可奖励数值不等的丧点。丧点可用于参与站内读写活动，作业活动也会奖励丧点。丧点荣誉性较高，没有其他实际作用。用户的等级也影响：可以创建的收藏清单的数量，可以发送陌生人私信的数量，可以关联的马甲账户数量。</p>
                                                <p><strong>1级</strong>能下载讨论帖，看边限内容，发文。</p>
                                                <p><strong>2级</strong>能回帖，能（需作者开放下载）下载“讨论贴格式”的含评论书籍，能在用户的问题箱提问，能新建讨论主题帖，能发动态。</p>
                                                <p><strong>3级</strong>能（需作者开放下载）下载“脱水”书籍；能<code>关联马甲号</code>（从编辑资料进入），关联后能免密码登陆马甲，能创建收藏清单，能看边限目录，筛选边限tag相关。</p>
                                                <p>一般新账户连续签到2天即为1级，签到6天即2级，13天即3级（注意这只是估计，实际使用因为用户行为，升级天数浮动数日都是正常情况，请参见5.2和自身情况进行细致对比，不要急于发问）。三级以上用户所获得的功能基本一致。总而言之，本站功能对大部分用户开放，无需在升级上耗费太大精力。</p>

                        ...
                        <div class="help-explanation">
                            <div id="help-1">
                                <h2>1 网站界面</h4>
                                    <div id="help-1-1">
                                        ...
                                        <ul>
                                            ...
                                            <li>重置邮件也不管用：很可能是邮箱输入有误，请将用户名、邮箱、注册时间、具体失效页面截图，发给微博账户“废文网大内总管”，查看具体情况。如有错误，手工修改错误信息。</li>
                                    ...
                                    <div id="help-1-2">
                                        ...
                                        <div class="main-text indentation">
                                            <p>以上是本站特色的虚拟积分系统。发文、发帖、回帖、点评、签到、参加活动……都能增加这些积分。积分影响等级，等级影响到网站一小部分的功能使用，比如发送私信等。咸鱼和剩饭能够对作者进行奖励。丧点可以用于参加站内作业活动。本站大部分功能对全部用户开放，不需要对积分获取过于执着。</p>
                                ...
                                <div id="help-3">
                                    ...
                                    <div id="help-3-2">
                                        <h4>3.2 作者能做的操作</h4>
                                        <h6>以下操作都从文章首页的<code>“修改文案”</code>进入，拖拽到底部将对应项打勾/取消勾选</h6>
                                        <ul>
                                            <li>是否公开书籍：如果不勾选，则书籍不对外开放，只能从个人主页进入，可以作为<code>私下存文</code>的渠道。管理员发现帖子标题等处不规范，也会将该项取消勾选（也就是隐藏处理），作者修改好后可以自行公开，恢复帖子的阅读。请注意，24h无正文的，系统会自动隐藏。作者发文后可自己选择公开</li>
                                            <li>是否允许跟帖：如果不勾选，其他读者只能看文不能评论。如果遇到文下争议，来不及等待管理员处理，此操作可以应急。（之后可以悠哉悠哉地去管理版面登记，举报不友好评论，惩罚ky分子）</li>
                                            <li>是否允许讨论帖下载：勾选后，其他读者能够以支付作者咸鱼和剩饭为代价，实时下载包含书评在内、按时间顺序排列的全文txt文件作为存档。本选项默认不勾选。</li>

                        ...
                        <div class="help-explanation">
                            <div id="help-1">
                                ...
                                <div id="help-1-3">
                                    ...
                                    <ul>
                                        <li>签到按钮（登陆可见）：在导航栏最顶，有一个红色的<code>“我要签到”</code>按键。为了避免用户熬夜签到，签到按钮设置在<u>北京时间早上6-7点</u>开始出现，直到用户完成签到后再次消失等待下一天。签到有签到奖励，签到可以让用户升级，连续签到达到一定日期之后，奖励也会增加。</li>
                                        <li>文库：可以按照文章类型淘文的地方。</li>
                                        <li>论坛：本站其他讨论，以及站内用户概况。</li>
                                ...
                                <div id="help-1-4">
                                    <h4>1.4 首页格局</h4>
                                    <ul>
                                        <li>临时搜索（登陆可见）：可以搜索用户/主题贴/同人原著+CP。由于资源有限，暂时设置成一个用户15分钟内只能搜索一次。</li>
                            ...
                            <div id="help-2">
                                ...
                                <div id="help-2-1">
                                    ...
                                    <ul>
                                        <li><code>a. 单项淘文：</code>在文库去，点击任何关于“书籍进度（连载/完结/暂停）”，“书籍篇幅（短篇中篇长篇）”，“书籍原创性（原创/同人）”，“书籍性向（BL/GL/BG/GB/无CP/混合性向/其他性向）”，“书籍类型（科幻/奇幻/现代/古代...）”，“书籍标签（美强/强强/正剧/小甜饼/暗黑/HE...）”以上任何超链接，点击之后，都可以跳转进入筛选页面。浏览器收藏该页面，下次就可以直接淘这类文章。</li>
                                ...
                                <div id="help-2-4">
                                    ...
                                    <ul>
                                        ...
                                        <li>点赞：在单独章节下点击向上的小手，太太能够收到闪烁的黄色提醒</li>
                            ...
                            <div id="help-4">
                                ...
                                <div id="help-4-7">
                                    <h4>4.7 如何支持你们？</h4>
                                    <div class="indentation main-text">
                                        <p>感谢各位朋友好意，本站暂不需要经济支持，感恩笔芯！不过，欢迎有经验、有兴趣、有时间的朋友联系加入我们的开发工作，比如说：具有mysql数据库使用经验、laravel开发经验、app开发经验、熟悉PHP编程语言...如果感兴趣，联系方式按照程序员的惯例...相信你们一定是找得到的！</p>

...
<head>
    ...
    <link rel="stylesheet"
          href="<?php echo e(file_exists(public_path(\MLL\GraphQLPlayground\DownloadAssetsCommand::CSS_PATH_LOCAL))
    ...
    <link rel="shortcut icon"
          href="<?php echo e(file_exists(public_path(\MLL\GraphQLPlayground\DownloadAssetsCommand::FAVICON_PATH_LOCAL))
    ...
    <script src="<?php echo e(file_exists(public_path(\MLL\GraphQLPlayground\DownloadAssetsCommand::JS_PATH_LOCAL))

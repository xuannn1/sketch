...
class Post extends Model
{
    ...
    protected $columns = array('id', 'user_id', 'thread_id', 'body', 'is_anonymous', 'majia', 'creation_ip', 'created_at', 'last_edited_at', 'reply_to_post_id', 'reply_to_post_preview', 'reply_position', 'is_maintext', 'is_comment', 'use_markdown', 'use_indentation', 'is_top', 'is_highlighted', 'up_votes', 'down_votes', 'fold_votes', 'funny_votes', 'xianyus', 'shengfans', 'replies', 'is_folded', 'is_popular', 'is_longpost', 'allow_as_longpost', 'is_bianyuan', 'last_responded_at', 'deleted_at')  ; // 从这里排除可以不检出的column

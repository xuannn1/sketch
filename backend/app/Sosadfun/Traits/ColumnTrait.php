...
trait ColumnTrait{
    ...
    protected $post_columns = array('id', 'type', 'user_id', 'thread_id', 'title', 'preview','body', 'is_anonymous', 'majia', 'creation_ip', 'created_at', 'last_edited_at', 'reply_to_post_id', 'reply_to_post_preview', 'reply_position', 'use_markdown', 'use_indentation', 'up_votes', 'down_votes', 'fold_votes', 'funny_votes', 'xianyus', 'shengfans', 'replies', 'views', 'is_folded', 'is_longpost', 'allow_as_longpost', 'is_bianyuan', 'last_responded_at', 'deleted_at')  ; // 从这里排除可以不检出的column

    protected $postinfo_columns = array ('id', 'type', 'thread_id', 'title', 'preview', 'created_at', 'last_edited_at', 'up_votes', 'xianyus', 'shengfans', 'replies', 'views', 'is_folded', 'is_bianyuan', 'last_responded_at');

...
class CreateTagsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('tags', function (Blueprint $table) {
            ...
            $table->boolean('is_bianyuan')->default(false)->index();//是否边缘限制专有
            $table->boolean('is_primary')->default(false)->index();//是否属于主要的tag（分两种情况，具有channellimit，和不具有channellimit-长短篇，科幻奇幻，）
